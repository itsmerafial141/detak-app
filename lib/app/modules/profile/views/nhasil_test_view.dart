...
import 'nhasil_test_detail_view.dart';

class NHasilTestView extends GetView<ProfileController> {
  var controllers = Get.put(ProfileController());
  var totalTest = Get.arguments;

  NHasilTestView({Key? key}) : super(key: key);
  @override
